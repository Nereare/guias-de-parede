...
* [ ] Atualizar o número versão em qualquer arquivo de exemplo e no [arquivo Leia-Me](README.md) para a nova versão que esse *pull request* representa. O esquema de versionamento que nós usamos é o [SemVer](http://semver.org/).
